...
distributions instead of the two summary means the CSV carries. This writes
    ...
    pdfs/table4_dist.tex      quantiles / max / top-k / count above threshold
    pdfs/table4_quartiles.tex mean of each quartile bin
    pdfs/table4_dist.md       both of the above, for reading in the terminal
    pdfs/pareto_qed.pdf       quality-vs-novelty Pareto panels
    pdfs/novel_qed_dist.pdf   box + strip plot of the novel QED distributions

Usage:
    python scripts/make_table4_distribution.py [results_dir] [out_dir]
"""
