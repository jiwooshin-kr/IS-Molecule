...
echo "######## Phase 2: support floor ########"
# Directly tests the atomic-measure problem: tokens no candidate proposed at a
# position get zero probability. Mixing x_theta back in restores full support.
for FLOOR in 0.01 0.1 0.5; do
  run_eval "s1024_ours_N300_lam1000_floor${FLOOR}_win0.0-1.0" \
    "${OURS_ARGS[@]}" guidance.num_x0_samples=300 guidance.lambda_=1000 \
